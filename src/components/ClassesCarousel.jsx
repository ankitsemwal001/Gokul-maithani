...
const CLS_IMG_DIMS = {
  bakasana: { w: 864, h: 774 },
  natarajasana: { w: 849, h: 771 },
  pranayama: { w: 1024, h: 1024 },
  virabhadrasana: { w: 1440, h: 1440 },
  "ek-pada": { w: 491, h: 424 },
  mayurasana: { w: 493, h: 421 },
  bhujangasana: { w: 1440, h: 1440 },
};

function slideDims(img) {
  let dims = { w: 1440, h: 1440 };
  for (const key of Object.keys(CLS_IMG_DIMS)) {
    if (img.includes(key)) dims = CLS_IMG_DIMS[key];
  }
  return dims;
}
