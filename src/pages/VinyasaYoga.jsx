...
const BENEFITS = [
  {
    ...
    desc: "Continuous breath-led movement builds stamina and heart health.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21s-7-4.35-9.3-8.5C1 8.5 3.5 5.5 6.8 5.5c2.2 0 3.9 1.3 5.2 3.2 1.3-1.9 3-3.2 5.2-3.2 3.3 0 5.8 3 4.1 7C19 16.65 12 21 12 21z" />
      </svg>
    ),
  },
  {
    title: "Fluid Strength",
    desc: "Bodyweight transitions sculpt lean, functional muscle.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6">
  ...
  },
  {
    ...
    desc: "Synchronizing movement with ujjayi breath quiets the chatter of the mind.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6">
...
export default function VinyasaYoga() {
  usePageMeta({
    title: "Vinyasa Yoga & Flow Classes in Rishikesh | Gokul Maithani",
    description:
      "Energize with Vinyasa & Flow yoga classes in Rishikesh led by certified teacher Gokul Maithani. Breath-synchronized movement for stamina, strength and cardiovascular endurance at Tapovan studio.",
  ...
  return (
    <>
      <section className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] flex items-center overflow-hidden py-16 sm:py-20 md:py-0">
        <img
          src="/assets/natarajasana-dancer-pose-yoga-rishikesh.webp"
          className="absolute inset-0 w-full h-full object-cover saturate-[0.85]"
          alt="Vinyasa Yoga Flow Practice in Rishikesh"
          width="849"
          height="771"
          fetchpriority="high"
          decoding="async"
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
            <div className="max-w-2xl">
              ...
              <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-display text-sage-dark leading-tight mb-4 sm:mb-6">
                Vinyasa <em className="text-primary-dark">Yoga</em> &amp; Flow
              </h1>
              <p className="text-charcoal/80 text-sm sm:text-base md:text-lg max-w-xl mb-8 sm:mb-10 leading-relaxed">
                A fluid, breath-synchronized practice that links postures into
                graceful sequences, building stamina, heat, and full-body
                resilience.
              </p>
        ...
        <Reveal>
          <div>
            ...
            <p className="text-charcoal/75 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
              Vinyasa means "to place in a special way." Movements are linked
              seamlessly to the breath, creating a meditative, moving flow that
              raises internal heat and challenges cardiovascular endurance.
            </p>
            <p className="text-charcoal/75 text-sm sm:text-base leading-relaxed">
              Each session builds progressively, helping practitioners develop
              functional strength, coordination, and deep mental focus while
              staying fully present in the body.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal>
          <div className="card p-6 sm:p-10 h-fit static md:sticky md:top-32 shadow-card">
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-6 sm:mt-8 pt-4 border-t border-sage/15">
              <img src="/assets/gokul-maithani-yoga-teacher-portrait-rishikesh.webp" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full object-cover saturate-[0.85]" alt="Gokul Maithani Vinyasa Yoga Teacher in Rishikesh" width="861" height="834" loading="lazy" decoding="async" />
              <div>
        ...
        <Reveal>
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-white/70 text-sm sm:text-base mb-8 sm:mb-10 leading-relaxed">
              Experience the freedom of a fluid, energizing flow practice in
